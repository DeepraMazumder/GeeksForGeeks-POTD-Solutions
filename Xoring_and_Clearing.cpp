...
Explanation: First we take xor of every element with their indices, like (1xor0), (2xor1), (3xor2), (4xor3) and so on. Now print the resultant array. Now set all the elements of array to zero. Now print the 
resultant array.
...
Explanation: First we take xor of every element with their indices, like (1xor0), (2xor1), (3xor2). Now print the resultant array. Now set all the elements of array to zero. Now print the resultant array.
